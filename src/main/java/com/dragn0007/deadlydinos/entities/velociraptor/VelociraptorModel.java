...
public class VelociraptorModel extends DefaultedEntityGeoModel<Velociraptor> {

    public VelociraptorModel() {
        super(new ResourceLocation(DeadlyDinos.MODID, "velociraptor"), true);
    }

    @Override
    public void setCustomAnimations(Velociraptor animatable, long instanceId, AnimationState<Velociraptor> animationState) {
    ...
    public enum FemaleVariant {
        ...
        SILVER(new ResourceLocation(DeadlyDinos.MODID, "textures/entity/velociraptor/female_silver.png")),
        CREAM(new ResourceLocation(DeadlyDinos.MODID, "textures/entity/velociraptor/female_cream.png"));
    ...
    public enum MaleVariant {
        ...
        SILVER(new ResourceLocation(DeadlyDinos.MODID, "textures/entity/velociraptor/male_silver.png")),
        CREAM(new ResourceLocation(DeadlyDinos.MODID, "textures/entity/velociraptor/male_cream.png"));
    ...
    @Override
    public ResourceLocation getModelResource(Velociraptor object) {
        return MODEL;
    }

    @Override
    public ResourceLocation getTextureResource(Velociraptor object) {
        if (object.isFemale()) {
    ...
    @Override
    public ResourceLocation getAnimationResource(Velociraptor animatable) {
        return ANIMATION;
    }
}

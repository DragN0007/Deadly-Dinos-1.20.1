...
public class AnomalyAcrocanthosaurusModel extends GeoModel<AnomalyAcrocanthosaurus> {
    ...
    public enum FemaleVariant {
        BLACK(new ResourceLocation(DeadlyDinos.MODID, "textures/entity/acrocanthosaurus/female_anomaly.png"));
    ...
    public enum MaleVariant {
        BLACK(new ResourceLocation(DeadlyDinos.MODID, "textures/entity/acrocanthosaurus/male_anomaly.png"));

...
public class DiplodocusModel extends DefaultedEntityGeoModel<Diplodocus> {
    ...
    @Override
    public void setCustomAnimations(Diplodocus animatable, long instanceId, AnimationState<Diplodocus> animationState) {
    ...
    @Override
    public ResourceLocation getTextureResource(Diplodocus object) {
        if (object.isFemale()) {
    ...
    @Override
    public ResourceLocation getAnimationResource(Diplodocus animatable) {
        return ANIMATION;
    }
}

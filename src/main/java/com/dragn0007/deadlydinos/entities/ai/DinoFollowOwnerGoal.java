...
public class DinoFollowOwnerGoal extends Goal {
   public final AbstractTamableDino tamable;
   ...
   public DinoFollowOwnerGoal(AbstractTamableDino p_25294_, double v, float p_25296_, float p_25297_, boolean p_25298_) {

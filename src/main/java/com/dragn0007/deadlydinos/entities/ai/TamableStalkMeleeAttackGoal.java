...
public class TamableStalkMeleeAttackGoal extends Goal {
   public final AbstractTamableDino mob;
   ...
   public TamableStalkMeleeAttackGoal(AbstractTamableDino dino, double speedMod, boolean followingTargetEvenIfNotSeen) {
      this.mob = dino;

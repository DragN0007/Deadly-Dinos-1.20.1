...
import com.dragn0007.deadlydinos.entities.amargasaurus.AmargasaurusRender;
import com.dragn0007.deadlydinos.entities.anurognathus.AnurognathusRender;
...
import com.dragn0007.deadlydinos.entities.libanoculex.LibanoculexRender;
import com.dragn0007.deadlydinos.entities.meganeura.MeganeuraRender;
...
import com.dragn0007.deadlydinos.entities.spinosaurus.SpinosaurusRender;
...
public class DDDClientEvent {
    ...
    public static void clientSetupEvent(FMLClientSetupEvent event) {
        ...
        EntityRenderers.register(EntityTypes.MEGANEURA.get(), MeganeuraRender::new);
        EntityRenderers.register(EntityTypes.LIBANOCULEX.get(), LibanoculexRender::new);
        EntityRenderers.register(EntityTypes.SPINOSAURUS.get(), SpinosaurusRender::new);

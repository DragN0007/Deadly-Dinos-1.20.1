...
public class TinyInvScreen extends AbstractContainerScreen<TinyInvMenu> {
    public static final ResourceLocation INVENTORY_LOCATION = new ResourceLocation(DeadlyDinos.MODID, "textures/gui/tiny.png");
    public final AbstractTamableDino dino;

    public TinyInvScreen(TinyInvMenu menu, Inventory inventory, Component component) {

...
public class ThrownOlorotitanEgg extends ThrowableItemProjectile {
   public ThrownOlorotitanEgg(EntityType<? extends ThrownOlorotitanEgg> p_37473_, Level p_37474_) {
      super(p_37473_, p_37474_);
   }

   public ThrownOlorotitanEgg(Level p_37481_, LivingEntity p_37482_) {
      super(EntityType.EGG, p_37482_, p_37481_);
   }

   public ThrownOlorotitanEgg(Level p_37476_, double p_37477_, double p_37478_, double p_37479_) {
   ...
   public void onHit(HitResult p_37488_) {
      ...
      if (!this.level().isClientSide) {
         ...
         for (int j = 0; j < i; ++j) {
            if (getItem().is(DDDItems.FERTILIZED_OLOROTITAN_EGG.get())) {
               Olorotitan dino = EntityTypes.OLOROTITAN.get().create(this.level());
               dino.setAge(-24000);

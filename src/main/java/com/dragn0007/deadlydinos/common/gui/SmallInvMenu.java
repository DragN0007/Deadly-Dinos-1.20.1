...
public class SmallInvMenu extends AbstractContainerMenu {

    public Container container;
    public AbstractDinoMount mount;

    public SmallInvMenu(int containerId, Inventory inventory, FriendlyByteBuf extraData) {
    ...
    public SmallInvMenu(int containerId, Inventory inventory, Container container, AbstractDinoMount abstractOMount) {
        ...
        this.addSlot(new Slot(this.container, oMountSlots++, 8, 18) {
            ...
            public boolean mayPlace(ItemStack itemStack) {
                return itemStack.is(Items.SADDLE) && !this.hasItem() && SmallInvMenu.this.mount.isSaddleable();
            }

            @Override
            public boolean isActive() {
                return SmallInvMenu.this.mount.isSaddleable();
            }
        });
        ...
        this.addSlot(new Slot(this.container, oMountSlots++, 8, 36) {
            ...
            public boolean mayPlace(ItemStack itemStack) {
                if (itemStack.getItem() instanceof HorseArmorItem) {
                    ...
                    return !this.hasItem() && SmallInvMenu.this.mount.canHoldBedroll();
                }
                return false;
            }

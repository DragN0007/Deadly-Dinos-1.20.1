...
public class DDDItemModelProvider extends ItemModelProvider {
    ...
    public void registerModels() {
        ...
        simpleItem(DDDItems.MEGARAPTOR_TROPHY);

        advancedItem(DDDItems.MEI_LONG_SPAWN_EGG, "mei_long_egg");
        advancedItem(DDDItems.FERTILIZED_MEI_LONG_EGG, "mei_long_egg");
        ...
        advancedItem(DDDItems.TARBOSAURUS_SPAWN_EGG, "tarbosaurus_egg");
        advancedItem(DDDItems.FERTILIZED_TARBOSAURUS_EGG, "tarbosaurus_egg");
        simpleItem(DDDItems.TARBOSAURUS_EGG);
        simpleItem(DDDItems.TARBOSAURUS_TROPHY);
        ...
        advancedItem(DDDItems.VELOCIRAPTOR_SPAWN_EGG, "velociraptor_egg");
        advancedItem(DDDItems.FERTILIZED_VELOCIRAPTOR_EGG, "velociraptor_egg");
        simpleItem(DDDItems.VELOCIRAPTOR_EGG);
        simpleItem(DDDItems.VELOCIRAPTOR_TROPHY);
        ...
        advancedItem(DDDItems.AMARGASAURUS_SPAWN_EGG, "amargasaurus_egg");
        advancedItem(DDDItems.FERTILIZED_AMARGASAURUS_EGG, "amargasaurus_egg");
        simpleItem(DDDItems.AMARGASAURUS_EGG);
        simpleItem(DDDItems.AMARGASAURUS_TROPHY);

        advancedItem(DDDItems.DIPLODOCUS_SPAWN_EGG, "diplodocus_egg");
        advancedItem(DDDItems.FERTILIZED_DIPLODOCUS_EGG, "diplodocus_egg");
        simpleItem(DDDItems.DIPLODOCUS_EGG);
        simpleItem(DDDItems.DIPLODOCUS_TROPHY);

        advancedItem(DDDItems.GRYPOSAURUS_SPAWN_EGG, "gryposaurus_egg");
        advancedItem(DDDItems.FERTILIZED_GRYPOSAURUS_EGG, "gryposaurus_egg");
        simpleItem(DDDItems.GRYPOSAURUS_EGG);
        simpleItem(DDDItems.GRYPOSAURUS_TROPHY);
        ...
        advancedItem(DDDItems.LIBANOCULEX_SPAWN_EGG, "libanoculex_egg");
        advancedItem(DDDItems.FERTILIZED_LIBANOCULEX_EGG, "libanoculex_egg");
        simpleItem(DDDItems.LIBANOCULEX_EGG);
